...
const skillsInfo = [
  { name: SKILL.HTML, src: html },
  { name: SKILL.CSS, src: css },
  { name: SKILL.JAVASCRIPT, src: javaScript },
  { name: SKILL.REACT, src: react },
  { name: SKILL.TYPESCRIPT, src: typeJs },
  { name: SKILL.NEXTJS, src: nextJs },
  { name: SKILL.TAILWIND, src: tailwind },
  { name: SKILL.BOOTSTRAP, src: bootStrap },
  { name: SKILL.DART, src: dart },
  { name: SKILL.FLUTTER, src: flutter },
  { name: SKILL.GIT, src: git },
  { name: SKILL.GITHUB, src: gitHub },
  { name: SKILL.SLACK, src: slack },
  { name: SKILL.NOTION, src: notion },
  { name: SKILL.FIGMA, src: figma },
  { name: SKILL.PHOTOSHOP, src: photoshop },
  { name: SKILL.ILLUSTRATOR, src: illustrator },
];
